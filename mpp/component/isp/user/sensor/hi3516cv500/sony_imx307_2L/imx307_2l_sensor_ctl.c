...
void imx307_2l_wdr_1080p30_2to1_init(VI_PIPE ViPipe)
{
    // 10bit
    imx307_2l_write_register(ViPipe, 0x3000, 0x01); //  standby
    imx307_2l_write_register(ViPipe, 0x3002, 0x01); //  XMSTA;
    ...
    imx307_2l_write_register(ViPipe, 0x3011, 0x02); //  Change after reset;
    imx307_2l_write_register(ViPipe, 0x3018, 0xC4); //  VMAX[7:0]
    imx307_2l_write_register(ViPipe, 0x3019, 0x04); //  VMAX[15:8]
    imx307_2l_write_register(ViPipe, 0x301C, 0xEC); //  HMAX[7:0]      0x14a0->25fps;
    imx307_2l_write_register(ViPipe, 0x301D, 0x07); //  HMAX[15:8]     0x1130->30fps;

    imx307_2l_write_register(ViPipe, 0x3020, 0x02); //  SHS1
    imx307_2l_write_register(ViPipe, 0x3021, 0x00); //  SHS1
    imx307_2l_write_register(ViPipe, 0x3024, 0x53); //  SHS2
    imx307_2l_write_register(ViPipe, 0x3025, 0x04); //  SHS2
    imx307_2l_write_register(ViPipe, 0x3030, 0xE1); //  RHS1
    imx307_2l_write_register(ViPipe, 0x3031, 0x00); //  RHS1
    imx307_2l_write_register(ViPipe, 0x303A, 0x08);          //add
    imx307_2l_write_register(ViPipe, 0x303C, 0x04); //  WINPV  //add
    imx307_2l_write_register(ViPipe, 0x303D, 0x00);          //add
    imx307_2l_write_register(ViPipe, 0x303E, 0x41); //  WINWV  //add
    imx307_2l_write_register(ViPipe, 0x303F, 0x04);          //add
    ...
    //imx307_2l_write_register(ViPipe, 0x304B, 0x0A); //  XVSOUTSEL & XHSOUTSEL  //add
    ...
    imx307_2l_write_register(ViPipe, 0x309E, 0x4A);
    imx307_2l_write_register(ViPipe, 0x309F, 0x4A);
    imx307_2l_write_register(ViPipe, 0x30D2, 0x19); //add
    imx307_2l_write_register(ViPipe, 0x30D7, 0x03); //add
