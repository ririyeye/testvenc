...
static HI_S32 cmos_get_ae_default(VI_PIPE ViPipe, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
    ...
    if (pstSnsState->u8ImgMode == IMX335_5M_30FPS_12BIT_LINEAR_MODE) {
        ...
        U32MaxFps = 30;
    } else if (pstSnsState->u8ImgMode == IMX335_5M_30FPS_10BIT_WDR_MODE) {
        u32Fll = IMX335_VMAX_5M_30FPS_10BIT_WDR;
        U32MaxFps = 30;
    } else if (pstSnsState->u8ImgMode == IMX335_4M_25FPS_10BIT_WDR_MODE) {
...
static HI_VOID cmos_fps_set(VI_PIPE ViPipe, HI_FLOAT f32Fps, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
    ...
    switch (pstSnsState->u8ImgMode) {
        ...
        case IMX335_5M_30FPS_10BIT_WDR_MODE:
            ...
            pstAeSnsDft->u32LinesPer500ms = IMX335_VMAX_5M_30FPS_10BIT_WDR*30;//Because one FSC is equal to 2 VMAX
            break;
        ...
        case IMX335_4M_25FPS_10BIT_WDR_MODE:
            ...
            pstAeSnsDft->u32LinesPer500ms = IMX335_VMAX_4M_25FPS_10BIT_WDR*30;//Because one FSC is equal to 2 VMAX
            break;
...
static HI_VOID cmos_inttime_update(VI_PIPE ViPipe, HI_U32 u32IntTime)
{
    ...
    if (pstSnsState->enWDRMode == WDR_MODE_2To1_LINE) {
        if (u8ExpFrameType == IMX335_FRAME_TYPE_SHORT) { /* short exposure */
...
static HI_VOID cmos_gains_update(VI_PIPE ViPipe, HI_U32 u32Again, HI_U32 u32Dgain)
{
    ...
    if (pstSnsState->enWDRMode == WDR_MODE_2To1_LINE) {
        if (u8ExpFrame == IMX335_FRAME_TYPE_LONG) {
