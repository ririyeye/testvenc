...
static HI_VOID cmos_fps_set(VI_PIPE ViPipe, HI_FLOAT f32Fps, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
    ...
    pstAeSnsDft->u32LinesPer500ms = g_astImx458ModeTbl[pstSnsState->u8ImgMode].u32VMax*f32MaxFps / 2;
...
static HI_VOID cmos_set_pixel_detect(VI_PIPE ViPipe, HI_BOOL bEnable)
{
    ...
    if (bEnable) { /* setup for ISP pixel calibration mode */
        ...
        imx458_write_register(ViPipe, IMX458_COARSE_INTEG_TIME_L, (u32CoarseTime & 0xFF));
        imx458_write_register(ViPipe, IMX458_COARSE_INTEG_TIME_H, ((u32CoarseTime >> 8) & 0xFF));
        imx458_write_register(ViPipe, IMX458_ANA_GAIN_GLOBAL_L, (u32Again & 0xFF));
        imx458_write_register(ViPipe, IMX458_ANA_GAIN_GLOBAL_H, ((u32Again >> 8) & 0x1));
        imx458_write_register(ViPipe, IMX458_DIG_GAIN_GLOBAL_L, (u32Dgain & 0xFF));
        imx458_write_register(ViPipe, IMX458_DIG_GAIN_GLOBAL_H, ((u32Dgain >> 8) & 0xF));
        imx458_write_register(ViPipe, IMX458_DIG_GAIN_GLOBAL_L+2, (u32Dgain & 0xFF));
        imx458_write_register(ViPipe, IMX458_DIG_GAIN_GLOBAL_H+2, ((u32Dgain >> 8) & 0xF));
        imx458_write_register(ViPipe, IMX458_DIG_GAIN_GLOBAL_L+4, (u32Dgain & 0xFF));
        imx458_write_register(ViPipe, IMX458_DIG_GAIN_GLOBAL_H+4, ((u32Dgain >> 8) & 0xF));
        imx458_write_register(ViPipe, IMX458_DIG_GAIN_GLOBAL_L+6, (u32Dgain & 0xFF));
        imx458_write_register(ViPipe, IMX458_DIG_GAIN_GLOBAL_H+6, ((u32Dgain >> 8) & 0xF));
        imx458_write_register(ViPipe, IMX458_VMAX_L, (u32Vmax & 0xFF));
        imx458_write_register(ViPipe, IMX458_VMAX_H, ((u32Vmax >> 8) & 0xFF));
