...
static VI_PIPE_ATTR_S PIPE_ATTR_BT656_BASE =
{
...
HI_S32 SAMPLE_COMM_VI_GetComboAttrBySns(SAMPLE_SNS_TYPE_E enSnsType, combo_dev_t MipiDev, combo_dev_attr_t* pstComboAttr)
{
    switch (enSnsType)
    {
        ...
        case HT_BT656_2M_30FPS_8BIT:
            memcpy_s(pstComboAttr, sizeof(combo_dev_attr_t), &BT656_2M_30FPS_ATTR, sizeof(combo_dev_attr_t));
            break;
...
HI_S32 SAMPLE_COMM_VI_GetDevAttrBySns(SAMPLE_SNS_TYPE_E enSnsType, VI_DEV_ATTR_S* pstViDevAttr)
{
    switch (enSnsType)
    {
        ...
        case HT_BT656_2M_30FPS_8BIT:
            memcpy(pstViDevAttr, &DEV_ATTR_BT656_BASE, sizeof(VI_DEV_ATTR_S));
            break;
...
HI_S32 SAMPLE_COMM_VI_GetPipeAttrBySns(SAMPLE_SNS_TYPE_E enSnsType, VI_PIPE_ATTR_S* pstPipeAttr)
{
    switch (enSnsType)
    {
        ...
        case HT_BT656_2M_30FPS_8BIT:
            memcpy_s(pstPipeAttr, sizeof(VI_PIPE_ATTR_S), &PIPE_ATTR_BT656_BASE, sizeof(VI_PIPE_ATTR_S));
            break;
